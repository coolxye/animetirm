...
namespace AnimeTidyLib
{
    ...
    /// </list>
    /// </remarks>
    [Designer(typeof(AnimeTidyLib.Design.ObjectListViewDesigner))]   
...
//                    break;
        ...
        /// </summary>
        static public Bitmap SortAscendingImage = AnimeTidyLib.Properties.Resources.SortAscending;

        /// <summary>
        /// Gets or sets the image that will be placed next to the Sort Descending command
        /// </summary>
        static public Bitmap SortDescendingImage = AnimeTidyLib.Properties.Resources.SortDescending;
