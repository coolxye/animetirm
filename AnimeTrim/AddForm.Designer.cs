namespace AnimeTrim
{
	partial class AddForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.cboGather = new System.Windows.Forms.ComboBox();
			...
			// tbName
			// 
			this.tbName.Location = new System.Drawing.Point(53, 39);
			...
			// cboGather
			// 
			this.cboGather.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.cboGather.FormattingEnabled = true;
			...
			this.Controls.Add(this.cboGather);
		...
		private System.Windows.Forms.ComboBox cboGather;
